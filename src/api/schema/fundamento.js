...
const FundamentoQuery = {
  ...
  fundamentoOne: FundamentoTC.getResolver('findOne', [UtilCrypt.deletedMiddleware]),
  fundamentoMany: FundamentoTC.getResolver('findMany', [UtilCrypt.deletedMiddleware]),
  fundamentoCount: FundamentoTC.getResolver('count', [UtilCrypt.deletedMiddleware]),
  fundamentoConnection: FundamentoTC.getResolver('connection', [UtilCrypt.deletedMiddleware]),
  fundamentoPagination: FundamentoTC.getResolver('pagination', [UtilCrypt.deletedMiddleware]),
};
...
const FundamentoMutation = {
  ...
  // fundamentoRemoveById: FundamentoTC.getResolver('removeById'),
  // fundamentoRemoveOne: FundamentoTC.getResolver('removeOne'),
  // fundamentoRemoveMany: FundamentoTC.getResolver('removeMany'),
};

export { FundamentoQuery, FundamentoMutation };
